...
public class NSSGatewayServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.nss.gateway.service.http.NSSGatewayServiceSoapService {
    ...
    private java.lang.String Plugin_NSSGateway_NSSGatewayService_address = "http://localhost:8081/gw-portlet/api/axis/Plugin_NSSGateway_NSSGatewayService";
    ...
    public com.nss.gateway.service.http.NSSGatewayServiceSoap getPlugin_NSSGateway_NSSGatewayService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nss.gateway.service.http.NSSGatewayServiceSoapBindingStub _stub = new com.nss.gateway.service.http.NSSGatewayServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nss.gateway.service.http.NSSGatewayServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nss.gateway.service.http.NSSGatewayServiceSoapBindingStub _stub = new com.nss.gateway.service.http.NSSGatewayServiceSoapBindingStub(new java.net.URL(Plugin_NSSGateway_NSSGatewayService_address), this);
                _stub.setPortName(getPlugin_NSSGateway_NSSGatewayServiceWSDDServiceName());
                return _stub;
            }
        }
